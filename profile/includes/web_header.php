<header class="main-header header-style-one">
            ...
            <div class="outer-box">
                ...
                <div class="header-top__right">
                    <div class="header-button-style1">
                        <a class="btn-one" href="login.php">
                            <span class="txt">
                                 Join with us<i class="icon-user arrow"></i>
                            </span>
                        </a>
                    </div>
                </div>
            ...
            <div class="outer-box">
                ...
                <div class="header-left">
                    <div class="main-logo-box">
                        <a href="../index.php">
                            <img src="../profile/img/logo.png" class="logo-img" alt="Awesome Logo" title="">
                            <div class="logo-img-text">astey</div>
                        </a>
                    </div>
            ...
            <div class="clearfix">
                ...
                <div class="logo float-left">
                    <a href="../index.php" class="img-responsive">
                        <img src="../profile/img/logo.png" class="logo-img" alt="Awesome Logo" title="">
                        <div class="logo-img-text" style="color: #81b536; !important">astey</div>
                    </a>
                </div>
                <!--Right Col-->
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="../index.php"><img src="../profile/img/logo.png" class="logo-img" alt=""
                        title="">
                    <div class="logo-img-text" style="color: #81b536; !important">astey</div>
                </a></div>
